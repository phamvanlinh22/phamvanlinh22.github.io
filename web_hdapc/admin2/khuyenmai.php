    ...
    $color = '#'.$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)];
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="taoKM.php" class="taokm" style="border: 1px solid blue;border-radius: 4px;background-color: blue;color: white; font-weight: 500;padding:6px;margin-right: 60px;margin-top: 5px;"><i class="fas fa-plus-circle"></i> &#160Tạo khuyến mãi &#160</a>
          </div>
          <table style="width: 100%;text-align: center;">
              <tr style="background-color: grey; color: white;height: 40px;font-size: 16px; ">
                <td class="tt1" style="width: 50px;">STT</td>
                <td class="tt1">Tên khuyến mãi</td>
                <td class="tt1">Sản phẩm khuyến mãi</td>
                <td class="tt1" style="width: 100px;">Giá trị (%)</td>
                <td class="tt1">Ngày bắt đầu</td>
                <td class="tt1">Ngày kết thúc</td>
              </tr>

            <?php
                $result=$sale->showSale();
                $i=0;
                if($result!=NULL){
            ...
            ?>  
              <tr style="color: #3D3C3C">
                <td class="tt1" style="width: 50px;"><?php echo $i ?></td>
                <td class="tt1"><?php echo $row['saleName'] ?></td>
                <td class="tt1" style="text-align: left; padding-left: 50px;">
                <?php 
                  $mangpd=[];
                  $mangpd=explode("-",$row['pdSale']);
                  // echo $mangpd;
                  foreach ($mangpd as $pd ) {
                     echo $pd."<br>";
                  }
                ?>
                </td>
                <td class="tt1" style="width: 180px;"><?php echo $row['percent']."%" ?></td>
                <td class="tt1"><?php echo $row['dStart'] ?></td>
                <td class="tt1"><?php echo $row['dEnd'] ?></td>
              </tr>
